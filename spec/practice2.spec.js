describe("Practice 2: Adding two very big numbers", function() {
    ...
    it("-7199254740990 + 9007199254740990 === 9000000000000000", function() {
        expect(add("-7199254740990", "9007199254740990")).toEqual("9000000000000000");
    });
    it("7199254740990  + -9007199254740990=== -9000000000000000", function() {
        expect(add("7199254740990", "-9007199254740990")).toEqual("-9000000000000000");
    });

    it("10  + -100=== -90", function() {
        expect(add("10", "-100")).toEqual("-90");
    });
